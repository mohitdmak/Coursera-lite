...
(function(e, t) {
  ...
  function d(e, t) {
    ...
    var o = e.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_FOLLOWING,
        n = o ? e : t, i = o ? t : e, a = document.createRange();
  ...
  function m(e, t, o, n) {
    return Q(t['offset' + e], t['scroll' + e], o['client' + e], o['offset' + e],
             o['scroll' + e],
             ie(10) ? o['offset' + e] +
  ...
  function u(e, o) {
    var i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
        r = ie(10), p = 'HTML' === o.nodeName, s = g(e), d = g(o), a = n(e),
        f = t(o), m = parseFloat(f.borderTopWidth, 10),
    ...
    if (u.marginTop = 0, u.marginLeft = 0, !r && p) {
      ...
      u.top -= m - b, u.bottom -= m - b, u.left -= h - y, u.right -= h - y,
          u.marginTop = b, u.marginLeft = y
    }
  ...
  function b(e) {
    var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
        o = e.ownerDocument.documentElement, n = u(e, o),
        i = Q(o.clientWidth, window.innerWidth || 0),
        r = Q(o.clientHeight, window.innerHeight || 0), p = t ? 0 : a(o),
        s = t ? 0 : a(o, 'left'), d = {
  ...
  function E(e, t, i, r) {
    ...
    if ('viewport' === r)
      ...
      if ('HTML' === l.nodeName && !y(a)) {
        ...
        s.top += f.top - f.marginTop, s.bottom = c + f.top,
  ...
  function x(e, t, o, n, i) {
    ...
    var p = E(o, n, r, i), s = {
      ...
      left : {width : t.left - p.left, height : p.height}
        ...
        d = Object.keys(s)
                .map(function(
                    e) { return de({key : e}, s[e], {area : v(s[e])}) })
    ...
    return i.forEach(function(t) {
      ...
      t.enabled && e(n) &&
          (o.offsets.popper = c(o.offsets.popper),
           o.offsets.reference = c(o.offsets.reference), o = n(o, t))
    }),
           o
  }
  function k() {
    if (!this.state.isDestroyed) {
      ...
      e.placement =
          x(this.options.placement, e.offsets.reference, this.popper,
  ...
  function A(e, t, o, i) {
    ...
    p.addEventListener(t, o, {passive : !0}), r || A(n(p.parentNode), t, o, i),
        i.push(p)
  }
  function I(e, t, o, i) {
    o.updateBound = i,
  ...
  function V(e) {
    var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
        o = le.indexOf(e), n = le.slice(o + 1).concat(le.slice(0, o));
  ...
  function z(e, t, o, n) {
    ...
    if ('vh' === p || 'vw' === p) {
      var a;
      return a = 'vh' === p ? Q(document.documentElement.clientHeight,
           ...
           modifiers : {
             ...
             preventOverflow : {
               ...
               fn : function(e, t) {
                 ...
                 var n = E(e.instance.popper, e.instance.reference, t.padding,
                           o, e.positionFixed);
                 t.boundaries = n;
                 var i = t.priority, p = e.offsets.popper, s = {
                   primary : function(e) {
                     var o = p[e];
                     return p[e] < n[e] && !t.escapeWithReference &&
                                (o = Q(p[e], n[e])),
                            se({}, e, o)
                   },
             ...
             arrow : {
               ...
               fn : function(e, o) {
                 ...
                 return v = Q(X(s[l] - u, v), 0), e.arrowElement = i,
                        e.offsets.arrow =
             ...
             flip : {
               ...
               fn : function(e, t) {
                 ...
                 if (e.flipped && e.placement === e.originalPlacement)
                   return e;
                 var o = E(e.instance.popper, e.instance.reference, t.padding,
                 ...
                 return p.forEach(function(s, d) {
                   ...
                   (m || b || w) &&
                       (e.flipped = !0, (m || b) && (n = p[d + 1]),
                        w && (r = K(r)), e.placement = n + (r ? '-' + r : ''),
                        e.offsets.popper =
                            de({}, e.offsets.popper,
                               T(e.instance.popper, e.offsets.reference,
                                 e.placement)),
